...
/*
 XMPP封装2.0版本
 修复在读取好友列表时候，卡死情况，在初始化时候预读花名册coredata
 修复对方发送消息，在最近联系人列表中不显示的问题
...
/*
 ...
 libXml2  需要设置$(SDKROOT)/usr/include/libxml2
 libresolv
 CFNetWork
 Security
 libidn.a(加入xmppFrameWork就有)
 QuartzCore(不是一定要添加，这个是作者需要使用的)
 libsqlite3(不是必须添加的，这个是作者记录最近联系人使用的)
 FMDB
